...
<div class="container-fluid">
  <div class="row">
    ...
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2" href="#" onclick="showSection('newsSection', 'Добавление новости')">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" id="sectionTitle">Добавление новости</h1>
    </div>
    <div id="newsSection" class="page-section">
        <div id="app1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input id="title" type="text" class="form-control" name="title" v-model="productData.title" placeholder="Тема" required />
                        </div>
                        <div class="form-group">
                            <h6>Картинка новости</h6>
                            <input class="form-control" type="file" id="image" name="image" @change="handleFileUpload" accept="image/*" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Редактировать новость</h5>
                        ...
                        <div class="modal-body">
                            <form id="editForm" @submit.prevent="submitEditForm">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="editTitle" v-model="editFormData.title" required>
                                </div>
                                <div class="mb-3">
                                    <label for="editDescription" class="form-label">Описание</label>
                                    <textarea class="form-control" id="editDescription" v-model="editFormData.description" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="editImage" class="form-label">Изображение</label>
                                    <input type="file" class="form-control" id="editImage" @change="handleEditImageUpload" accept="image/*">
                                    <img id="editImagePreview" :src="editFormData.image" alt="Предпросмотр изображения" style="max-width: 100%; margin-top: 10px;">
                                </div>
                            </form>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @click="closeEditModal">Закрыть</button>
                            <button type="button" class="btn btn-primary" @click="submitEditForm">Сохранить изменения</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <h2>Данные о добавленных новостях</h2>
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    $sql = "SELECT id, image, date, title, description FROM news";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                                    <button class='btn btn-danger btn-sm' onclick='deleteRow(" . $row["id"] . ")'>Удалить</button>
                                    <button class='btn btn-primary btn-sm' data-bs-toggle='modal' data-bs-target='#editModal' @click=\"openEditModal(" . $row['id'] . ")\">Редактировать</button>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form_radio_btn">
                            <input type="radio" id="image_type" name="content_type" value="image" v-model="contentType"> <label for="image_type">Изображение</label><br>
                            <input type="radio" id="file_type" name="content_type" value="file" v-model="contentType"> <label for="file_type">Файл</label><br>
                            <input type="radio" id="link_type" name="content_type" value="link" v-model="contentType"> <label for="link_type">Ссылка</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
